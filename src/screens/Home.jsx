...
import foooter from "../imgs/foooter.png";
  ...
  return (
    <>
      ...
      <div className="main__header__container">
        ...
        {/* <Fade bottom> */}
        <div className="header__container__wraper">
          ...
          <div className="main__header__container__right">
            <div className="main__header__container__right__contant">
              ...
              <div className="main__btn">
                <button className="main__btn__contant">
      ...
      <div className="footer__section">
        <div className="footer__container__wraper">
          <img
            className="footer__container__wraper__img"
            src={foooter}
            alt="footer"
          />
          <div className="footer__left__overlay__img">
          ...
          <div className="footer__container__wraper__overlay__contant">
            ...
            <div className="footer__wraper__contact__link">
              <div className="footer__wraper__contact__link__mail">
                <div className="footer__wraper__contact__link__mail__svg">
                  <svg
                    width="68"
                    height="56"
                    viewBox="0 0 68 56"
                ...
                <div className="footer__wraper__contact__link__heading">
                  E-Mail Adress
                </div>
                <div className="footer__wraper__contact__link__sub__heading">
                  salon23@gmail.com
                </div>
              </div>
              <div className="footer__wraper__contact__link__mail">
                <div className="footer__wraper__contact__link__mail__svg">
                  <svg
                    ...
                    stroke="currentColor"
                  >
                    <mask id="path-1-inside-1_13_4900" fill="white">
                      <path d="M11.9967 7.71528C12.2 10.7314 12.7083 13.6797 13.5217 16.4925L9.455 20.5592C8.06556 16.4925 7.18444 12.1886 6.87945 7.71528H11.9967ZM45.4111 48.4497C48.2917 49.2631 51.24 49.7714 54.2222 49.9747V55.0242C49.7489 54.7192 45.445 53.8381 41.3444 52.4825L45.4111 48.4497ZM15.25 0.9375H3.38889C1.525 0.9375 0 2.4625 0 4.32639C0 36.1481 25.7894 61.9375 57.6111 61.9375C59.475 61.9375 61 60.4125 61 58.5486V46.7214C61 44.8575 59.475 43.3325 57.6111 43.3325C53.4089 43.3325 49.3083 42.6547 45.5128 41.4008C45.1739 41.2653 44.8011 41.2314 44.4622 41.2314C43.5811 41.2314 42.7339 41.5703 42.0561 42.2142L34.6006 49.6697C25.01 44.7558 17.1478 36.9275 12.2678 27.3369L19.7233 19.8814C20.6722 18.9325 20.9433 17.6108 20.5706 16.4247C19.3167 12.6292 18.6389 8.5625 18.6389 4.32639C18.6389 2.4625 17.1139 0.9375 15.25 0.9375Z" />
                    </mask>
                    <path
                      d="M11.9967 7.71528C12.2 10.7314 12.7083 13.6797 13.5217 16.4925L9.455 20.5592C8.06556 16.4925 7.18444 12.1886 6.87945 7.71528H11.9967ZM45.4111 48.4497C48.2917 49.2631 51.24 49.7714 54.2222 49.9747V55.0242C49.7489 54.7192 45.445 53.8381 41.3444 52.4825L45.4111 48.4497ZM15.25 0.9375H3.38889C1.525 0.9375 0 2.4625 0 4.32639C0 36.1481 25.7894 61.9375 57.6111 61.9375C59.475 61.9375 61 60.4125 61 58.5486V46.7214C61 44.8575 59.475 43.3325 57.6111 43.3325C53.4089 43.3325 49.3083 42.6547 45.5128 41.4008C45.1739 41.2653 44.8011 41.2314 44.4622 41.2314C43.5811 41.2314 42.7339 41.5703 42.0561 42.2142L34.6006 49.6697C25.01 44.7558 17.1478 36.9275 12.2678 27.3369L19.7233 19.8814C20.6722 18.9325 20.9433 17.6108 20.5706 16.4247C19.3167 12.6292 18.6389 8.5625 18.6389 4.32639C18.6389 2.4625 17.1139 0.9375 15.25 0.9375Z"
                      fill="white"
                    />
                    <path
                      ...
                      fill="white"
                      mask="url(#path-1-inside-1_13_4900)"
                    />
                  </svg>
                </div>
                <div className="footer__wraper__contact__link__heading">
            ...
            <div className="footer__social__links">
              <div className="footer__social__links__svg">
                <svg
                  width="31"
                  height="31"
                  viewBox="0 0 31 31"
